...
def generate(count_dict = {'Charlotte County': 100, 'Seminole County': 100}):
    ...
    us_states = os.path.join(os.path.dirname(__file__), 'static/data', 'fl_counties.json')
    geo_json_data = json.load(open(us_states, 'r'))
    ...
    m.save(os.path.join(os.path.dirname(__file__), 'templates', 'map.html'))
    #m
