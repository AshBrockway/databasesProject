...
of.plot(fig, filename = '/var/www/Chess/databasesProject/chess/violin.html', auto_open=False)
#fig.write_image('/var/www/Chess/databasesProject/chess/static/violin1.png')
#fig.show()
